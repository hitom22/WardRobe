		...
		<fieldset>
			...
			<ul>
				<li>
					...
					<input type="text" id="member-id" name="member-id" value="${member.userId }" readonly> <!-- 기능을 위한 id, 쿼리스트링 생성을 위한 name -->
				</li>
				<li>
...
<%-- 					남 <input type="radio" id="member-gender" name="member-gender" value="M" <c:if test="${member.memberGender eq 'M' }">checked</c:if>> <!-- 기능을 위한 id, 쿼리스트링 생성을 위한 name --> --%>
<%-- 					여 <input type="radio" id="" name="member-gender" value="F" <c:if test="${member.memberGender eq 'F' }">checked</c:if>"> <!-- 기능을 위한 id, 쿼리스트링 생성을 위한 name --> --%>
				</li>
				<li>
				...
				<li>
					...
					<input type="text" id="member-memberDate" name="member-memberDate" value="${member.memberDate }"> <!-- 기능을 위한 id, 쿼리스트링 생성을 위한 name -->
				</li>
			</ul>
		</fieldset>
		<div>
