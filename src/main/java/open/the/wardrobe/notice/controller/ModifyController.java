package open.the.wardrobe.notice.controller;
...
import open.the.wardrobe.notice.model.service.NoticeService;
...
public class ModifyController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int noticeNo = Integer.parseInt(request.getParameter("noticeNo"));
		Notice notice = new Notice(noticeNo, noticeSubject, noticeContent); // 생성자 만들고 추가하는 방법
//		notice.setNoticeNo(noticeNo); // 생성자 안만들고 추가하는 방법
